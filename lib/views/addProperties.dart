...
import 'package:bloomzon_estate/views/myProperties.dart';
...
class _AddPropertiesState extends State<AddProperties> {
  ...
  startUpload() async {
    ...
    if(addressController.text == '') {
      addressController.text = 'sdfasdf';
      Fluttertoast.showToast(
    ...
    bool file1 = await imageFiles[0].exists();
    bool file2 = await imageFiles[1].exists();
