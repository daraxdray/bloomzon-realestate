...
import 'package:flutter/material.dart';
import 'package:bloomzon_estate/login.dart';
    ...
    return this._memoizer.runOnce(() async {
      ...
      if (isAuthenticated) {
        response = await http.get(
            Uri.encodeFull(
                "https://bloomzon.com/estate/api/get_property_message.php?receiver_id=" +
                    user[0] +
                    "&prop_id=$propId"),
            headers: {"Accept": "application/json"});
        List userData;
     //    print(userData);
     //    print("https://bloomzon.com/estate/api/get_property_message.php?receiver_id=" +
//            user[0] +
//            "&prop_id=$propId");
