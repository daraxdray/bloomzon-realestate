...
import 'package:bloomzon_estate/views/modifyProfile.dart';
import 'package:bloomzon_estate/views/testPicker.dart';
                        ...
                        child: Container(
                            ...
                            child: ClipOval(
                              child: FadeInImage.assetNetwork(
                                ...
                                image: "https://bloomzon.com/estate/assets/images/agents/${user[1]}/${user[2]}",
                                fit: BoxFit.cover,
                              ),
                            )
                        ),
...
//                ),
                GestureDetector(
                  ...
                  child: ProfileComponents(
                      listIcon: Icons.trending_up, listText: "Messages", clr: Color(0xffe5e4e4)),
                ),
//                GestureDetector(
//                  onTap: () {
//                    Navigator.push(
