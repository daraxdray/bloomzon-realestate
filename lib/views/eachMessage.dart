...
import 'package:bloomzon_estate/classes/message.dart';
import 'package:bloomzon_estate/classes/provider.dart';
import 'package:bloomzon_estate/components/InspectionView.dart';
import 'package:flutter/material.dart';
import 'package:bloomzon_estate/components/messagePill.dart';
  ...
  getMessage() async {
    return this._memoizer.runOnce(() async {
      ...
      if (isAuthenticated) {
        //print("----------------------------------------");
//        print(
//            "http://bloomzon.com/estate/api/get_single_message.php?receiver_id=${user[0]}&prop_id=$propId");
        response = await this.mainProvider.dio.get("https://bloomzon.com/estate"
            "/api/get_single_message.php", queryParameters: {
          "receiver_id":user[0],
          "prop_id":propId,
          "sender_id": senderId
        });
                ...
                child: new FutureBuilder(
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (!snapshot.hasData && _current > 0) {
                      return Center(
                        child: CircularProgressIndicator(backgroundColor: Color(0xffff0000),),
                      );
