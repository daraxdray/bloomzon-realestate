...
import 'package:bloomzon_estate/classes/property.dart';
import 'package:bloomzon_estate/components/requestComponent.dart';
import 'package:bloomzon_estate/services/favoritesServices.dart';
import 'package:bloomzon_estate/services/messageServices.dart';
import 'package:bloomzon_estate/views/eachMessage.dart';
import 'package:bloomzon_estate/views/eachRequest.dart';
  ...
  getData() async {
    ...
    if (isAuthenticated) {
      response = await http.get(
          Uri.encodeFull(
              "https://bloomzon.com/estate/get_message.php?receiver_id=${user[0]}&sender_no=${user[0]}"),
