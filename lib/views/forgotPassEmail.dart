...
import 'package:bloomzon_estate/views/confCode.dart';
import 'package:bloomzon_estate/views/modifyPassword.dart';
  ...
  final emailController = TextEditingController();
   ...
   _makeAuth(BuildContext context) async {
    ...
    if (email.length > 0) {
      ...
      String url = 'https://bloomzon.com/estate/api/password_reset_api.php';
        ...
        child: Column(
          ...
          children: <Widget>[
            Container(
              ...
              child: Image(
                image: AssetImage("assets/bz_color.png"),
