...
import 'package:bloomzon_estate/classes/success.dart';
...
class _ModifyProfileState extends State<ModifyProfile> {
  ...
  static final String uploadEndPoint =
      'https://bloomzon.com/estate/uploadProperty_image_api.php';
  String status = '';
...
//       isLoading = true;
    ...
    String url = 'https://bloomzon.com/estate/_update_user_api.php';
    ...
    if (success.status == "OK") {
      ...
      String uploadUrl = "https://bloomzon.com/estate/upload_image_api.php";
  ...
  _makeAuth() async {
    ...
    // set up POST request arguments
    String url = 'https://bloomzon.com/estate/_auth_user.php';
    Map<String, String> headers = {"Content-type": "application/json"};
    var s = '{"id": ' + " \"" + id + "\"" + ' }';
    String json = s;
    // make POST request
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Text(
                        ...
                        style:
                            TextStyle(color: Color(0xffb41a1a), fontSize: 20),
                      ),
                    ),
                  ],
                )),
                  ...
                  Center(
                    child: MaterialButton(
                      ...
                      child: Text(
                        'Ok!',
                        style:
                            TextStyle(fontSize: 18.0, color: Color(0xffb41a1a)),
                      ),
                    ),
                  ),
                ],
              ...
              child: Container(
                  ...
                  child: ClipOval(
                    child: FadeInImage.assetNetwork(
                      ...
                      image:
                          "https://bloomzon.com/estate/assets/images/agents/${user[1]}/${user[2]}",
                      fit: BoxFit.cover,
                    ),
                  )),
        ...
        child: Column(
          ...
          children: <Widget>[
            Padding(
                padding: EdgeInsets.all(15.0),
                child: Column(
                  children: <Widget>[CircularProgressIndicator(backgroundColor: Color(0xffff0000),)],
                )),
            Padding(
              padding: const EdgeInsets.only(left: 10, right: 10, top: 20),
              child: Row(
                                      ...
                                      child: Column(
                                        children: <Widget>[
                                          ...
                                          RaisedButton(
                                            ...
                                            color: Color(0xffb41a1a),
                                            disabledColor: Color(0xff610000),
                                          )
                                        ],
                                      ),
                                    ))
                                      ...
                                      child: Column(
                                        children: <Widget>[
                                          ...
                                          RaisedButton(
                                            ...
                                            color: Color(0xffb41a1a),
                                            disabledColor: Color(0xff7d0808),
                                          )
                                        ],
                                      ),
                                    ))
