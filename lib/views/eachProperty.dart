...
import 'package:bloomzon_estate/views/nearbyPlaces.dart';
...
// 0xff133ba5 -- dark blue
// 0xff780202 --  dark red
// 0xffba0000--- minimum red
...
class _EachPropertyState extends State<EachProperty> {
  ...
  sendMessage() async {
    ...
    if(user == null ){
      ...
      return showSimpleCustomDialog(context, "Error",
          "Please login before proceeding", "assets/error.gif");
    }
    ...
    if (title.length > 0 && message.length > 0) {
      ...
      String url = 'https://bloomzon.com/estate/send_message.php';
...
//function to get an address of a given location
  ...
  _addToFavorites() async {
    ...
    String url = "https://bloomzon.com/estate/api/send_to_favs_api.php";
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Text(
                        ...
                        style:
                            TextStyle(color: Color(0xff17191a), fontSize: 20),
                      ),
                    ),
                  ],
                )),
                  ...
                  Center(
                    child: MaterialButton(
                      ...
                      child: Text(
                        'Ok!',
                        style:
                            TextStyle(fontSize: 18.0, color: Color(0xffe80425)),
                      ),
                    ),
                  ),
                ],
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          IconButton(
            ...
            onPressed: () {
              Share.share(
                  "https://bloomzon.com/estate/property-details.php?prop=${item.prop_id}");
            },
          )
        ],
      ),
          ...
          children: <Widget>[
            Container(
              ...
              child: FadeInImage.assetNetwork(
                image: "https://bloomzon.com/estate/assets/upload/" +
                    item.prop_id +
                    "/" +
                    imgToDisplay,
                width: double.infinity,
                              ...
                              child: Column(
                                children: <Widget>[
                                  SizedBox(
                                    child: Image(
                                      image: NetworkImage(
                                          "https://bloomzon.com/estate/assets/upload/" +
                                              item.prop_id +
                                              "/" +
                                              f),
