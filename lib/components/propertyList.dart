...
import 'package:bloomzon_estate/views/editProperty.dart';
...
class _PropertyListState extends State<PropertyList> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onDoubleTap: () {
        Share.share("https://bloomzon.com/estate/property-details.php?prop=${widget.propId}");
      },
      child: Card(
        child: Container(
...
//                      );
                    ...
                    child: Container(
                      ...
                      child: Stack(
                        children: [
                          CachedNetworkImage(
                            imageUrl: "https://bloomzon.com/estate/assets/upload/" +
                                widget.propId +
                                "/" +
                                widget.imagePath,
