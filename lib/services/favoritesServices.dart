...
class FavoritesServices {
  // static const String url = "https://bloomzon.com/estate/api/get_favorites_api.php?userId=";

  static Future<List<Property>> getProperties() async{
    SharedPreferences preferences = await SharedPreferences.getInstance();
    List user = preferences.getStringList("user");
    String url = "https://bloomzon.com/estate/api/get_favorites_api.php?userId=${user[1]}";
 //    print(url);
    try {
